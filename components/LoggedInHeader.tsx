...
const LoggedInHeader: NextPage<Props> = ({}) => {
  ...
  return (
    <>
      <div className="flex justify-between w-full h-16 px-6 text-white md:px-0 md:justify-around position-absolute border-bottom-2 bg-slate-900">
        ...
        <div className="items-center justify-center hidden gap-8 text-sm md:flex">
          ...
          <div>
            <Link href="/admin/miempresa">Mi empresa</Link>
          </div>
          <div>
            <Link href="/admin/misturnos">Mis turnos</Link>
          </div>
          <div>
            <Link href="/admin/perfil">Mi perfil</Link>
          </div>
          <div onClick={logOut} className="cursor-pointer ml-7" title="Cerrar Sesión">
