  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      blobs.forEach((b) => {
        ...
        grad.addColorStop(
          0.5,
          `hsla(${b.hue},${b.sat}%,${b.lit}%,${b.alpha * 0.4})`,
        );
      ...
      <div className="relative z-[4] justify-between max-w-[1300px] 2xl:max-w-[1400px] mx-auto px-6 2xl:px-0 pt-[80px] 2xl:pt-[110px] pb-12 2xl:pb-16 flex items-center w-full flex-wrap lg:flex-nowrap">
        ...
        >
          ...
          >
            <div
              aria-hidden="true"
              className="w-10 h-10 rounded-full shrink-0 flex items-center justify-center text-white text-base font-extrabold"
              style={{ background: "linear-gradient(135deg,#ff8a5b,#dd4924)" }}
            >
              L
            </div>
            ...
            <div className="flex-1 min-w-0 flex flex-col gap-[6px]">
              <div className="flex items-center gap-2">
                <span aria-hidden="true" className="flex gap-px text-xs text-[#dd4924]">
                  {"★★★★★"}
                </span>
                <span aria-label="Calificación 4.9 sobre 5" className="text-xs font-semibold text-[#5a5a5a]">
                  <span className="font-bold text-[#1a1a1a]">4.9</span>
                  {" · 2.400+ reseñas"}
                </span>
              </div>

              <blockquote className="m-0 text-sm font-medium text-[#1a1a1a] leading-[1.55]" style={{ textWrap: "pretty" } as React.CSSProperties}>
                &ldquo;Recuperé{" "}
                <strong className="text-[#dd4924] font-bold">40 horas al mes</strong>
                {" "}que perdía coordinando turnos.&rdquo;
              </blockquote>

              <figcaption className="text-xs text-[#9a9a9a] font-medium mt-1">
                Laura · Peluquería en Buenos Aires
              </figcaption>
            </div>
          </figure> */}
        </motion.div>
