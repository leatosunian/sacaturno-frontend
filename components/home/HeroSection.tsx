      ...
      <div
        ...
        <div className="flex flex-col h-full w-fit md:flex-row ">
          <div className="flex flex-col justify-around w-full h-full gap-8 my-auto md:gap-16 md:h-fit">
            ...
            <div>
              <p className="mb-3 text-sm font-medium text-gray-500 xl:text-lg sm:text-md md:text-base">
              ...
              <p className="mb-2 text-sm font-medium text-gray-500 xl:text-lg sm:text-md md:text-base">
