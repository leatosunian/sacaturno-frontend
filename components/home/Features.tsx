...
const features = [
  {
    ...
    description:
      "Tus clientes pueden reservar su turno en cualquier momento desde tu link personalizado, sin esperas.",
    icon: <Zap className="w-5 h-5" />,
  },
  {
    title: "Control Total de Reservas",
    description:
      "Agendá turnos reservados manualmente o dejar que tus clientes reserven solos. Vos decidís cómo gestionar tu día.",
    icon: <Calendar className="w-5 h-5" />,
  },
  {
    title: "Automatizá tu Agenda",
    description:
      "Configurá la renovación automática de tu agenda y no pierdas tiempo cargando turnos cada semana.",
    icon: <Loop className="w-5 h-5" />,
  },
  {
    title: "Servicios Ilimitados",
    description:
      "Definí duración, precio y descripción para cada servicio que ofrecés.",
    icon: <IoIosInfinite className="w-6 h-6" />,
  },
  {
    title: "Cobro de señas",
    description:
      "Pedí un anticipo al reservar. Turno confirmado solo cuando se paga. Reducí las ausencias.",
...
export default function Features() {
  return (
    <section id="features" className="w-full pt-24 pb-16 lg:pb-18 lg:pt-28 2xl:pb-24 2xl:pt-36">
      <div className="px-4 mx-auto max-w-7xl md:px-6">
        ...
        >
          ...
          <p className="max-w-[800px] text-slate-600 dark:text-slate-300 md:text-base 2xl:text-lg">
            ...
            papel. SacaTurno gestiona y automatiza tu proceso de reservas para
            que vos te enfoques en brindar el mejor servicio a tus clientes.
          </p>
        </motion.div>
            ...
            <motion.div key={i} variants={item}>
              <Card className="h-full overflow-hidden  border-border/40 bg-gradient-to-b from-white to-slate-50/60 dark:from-gray-900 dark:to-gray-800/40  bg-white/10 border shadow-md hover:shadow-md hover:border-orange-800/15   transition-all duration-200 md:hover:shadow-orange-800/20 cursor-pointer">
                <CardContent className="flex cursor-pointer flex-col h-full p-4 lg:p-5 2xl:p-6">
                  ...
                  <h3 className="mb-1.5 2xl:mb-2 text-lg lg:text-lg 2xl:text-xl font-semibold text-slate-900 dark:text-slate-100">
                    {feature.title}
                  </h3>
                  <p className="text-sm lg:text-sm 2xl:text-base text-slate-600 dark:text-slate-300">
                    {feature.description}
                  </p>
                </CardContent>
              </Card>
