    ...
    answer: (
      <ol className="flex flex-col gap-2.5">
        <li className={step}>
          ...
          <span>
            Accedé al menú y hacé click en{" "}
            <strong className="text-gray-700 font-semibold">
              &ldquo;Reservar turno&rdquo;
            </strong>
            .
          </span>
        </li>
        <li className={step}>
          ...
          <span>Buscá el nombre de la empresa que querés.</span>
        </li>
        <li className={step}>
        ...
        <li className={step}>
          ...
          <span>Elegí el horario disponible que te quede mejor.</span>
        </li>
        <li className={step}>
        ...
        <li className={step}>
          ...
          <span>
            ...
            con todos los detalles. Si no lo ves, revisá la carpeta de spam.
          </span>
        </li>
      </ol>
    ),
      ...
      <ol className="flex flex-col gap-2.5">
        <li className={step}>
          ...
          <span>
            ...
            desde el correo que te enviaremos.
          </span>
        </li>
        <li className={step}>
          <span className={num}>2</span>
          <span>
            Iniciá sesión y accedé a{" "}
            <strong className="text-gray-700 font-semibold">
              &ldquo;Mi empresa&rdquo;
            </strong>
            .
          </span>
        </li>
        <li className={step}>
          <span className={num}>3</span>
          <span>
            Completá los datos de tu negocio y hacé click en{" "}
            <strong className="text-gray-700 font-semibold">
              &ldquo;Crear empresa&rdquo;
            </strong>
            .
          </span>
        </li>
        <li className={step}>
          ...
          <span>
            ...
            para poder comenzar a cargar turnos.
          </span>
        </li>
      </ol>
    ),
      ...
      <div className="flex flex-col gap-2">
        <div className={bullet}>
          ...
          <span>
            ...
            podés cancelarlo directamente desde la aplicación.
          </span>
        </div>
        <div className={bullet}>
          <span className={dot} />
          <span>
            ...
            contactá al negocio por correo o teléfono. Encontrás los datos de
            contacto en el correo de confirmación que recibiste.
          </span>
        </div>
      </div>
    ),
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className={bullet}>
          ...
          <span>
            ...
            algunos negocios pueden requerir el pago de una seña para confirmar
            la reserva. En ese caso, serás redirigido a Mercado Pago para
            completar el pago antes de que el turno quede confirmado.
          </span>
        </div>
        <div className={bullet}>
          <span className={dot} />
    ...
    answer: (
      <div className="flex flex-col gap-2">
        <div className={bullet}>
          <span className={dot} />
          <span>
            Ante cualquier duda o inconveniente, escribinos a{" "}
            <strong className="text-gray-700 font-semibold">
              leandrotosunian@hotmail.com
            </strong>{" "}
      ...
      <div className="flex flex-col items-center gap-10 2xl:gap-14 px-6">
        ...
        >
          <motion.div variants={headerItem}>
            <Badge
              className="rounded-full text-orange-600 bg-orange-100 border-0 px-4 py-1.5 text-sm font-medium mb-4"
              variant="secondary"
            >
              FAQ
            </Badge>
