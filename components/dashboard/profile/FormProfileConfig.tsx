          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 2xl:gap-5 w-full">
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className={`h-8 2xl:h-10 w-full rounded-md border px-3 text-xs 2xl:text-sm bg-gray-50 transition-all duration-200 ease-in-out hover:border-orange-600 focus:border-orange-600 focus:outline-none ${errors.surname ? "border-red-500" : "border-gray-200"}`}
              />
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className="h-8 2xl:h-10 w-full rounded-md border border-gray-200 px-3 text-xs 2xl:text-sm bg-gray-50 text-gray-400 cursor-not-allowed"
              />
            </div>
