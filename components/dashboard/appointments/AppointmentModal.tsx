  ...
  if (isBooked) {
    return (
      <div className="flex flex-col w-full gap-2 pb-1">
        ...
        <h4 className="relative inline-block w-full mb-3 px-2 mx-auto font-bold text-center uppercase" style={{ fontSize: 20 }}>
          Turno reservado
        ...
        <div className="flex flex-col gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100">
          ...
          <div className="flex gap-2 mt-1">
            <div className="flex flex-col gap-0.5 flex-1 p-3 bg-orange-50 rounded-lg border border-orange-100">
              <span className="text-xs font-bold uppercase tracking-wide text-gray-400">Precio</span>
              <span className="text-sm font-bold text-orange-600">$ {appointment?.price?.toLocaleString("es-AR")}</span>
            </div>
            {hasDeposit && (
              <div className="flex flex-col gap-0.5 flex-1 p-3 bg-orange-50 rounded-lg border border-orange-100">
                <span className="text-xs font-bold uppercase tracking-wide text-gray-400">Seña</span>
                <span className="text-sm font-bold text-blue-500">$ {appointment!.depositAmount!.toLocaleString("es-AR")}</span>
              </div>
            )}
          </div>
        </div>
        ...
        <Link target="_blank" href={`https://wa.me/54${appointment?.phone}`} className="w-full mt-3">
